...
// module-deps.gradle.kts — the FORK-OWNED dependency seam for `core/datastore` (white-label).
//
// `core/datastore/build.gradle.kts` is template-owned and FULL-COPIES on `/kmp-project-template-sync`.
